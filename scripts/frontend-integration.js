 ...
 * This file demonstrates how to integrate Defiledger with a web frontend
 */

// For React/Vue/Angular applications
export class DefiledgerClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DefiledgerClient(provider, contractAddress);
